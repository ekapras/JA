					...
					<div class="container">
						<div class="col-sm-12 text-center">
							<div id="projects-filter">
								<a href="<?php echo base_url(); ?>katalog/wood" class="active">metal art</a>
							</div>
						</div>
						<div class="row">
							...
							<?php foreach ($katalog as $u) {
							 ...
							 ?>
								<div class="item col-md-4 col-sm-6 col-xs-12 furniture">
							  		<figure>
			        					<img src="<?php echo base_url();?>assets/files/images/katalog/metal/<?php echo $u ->id;?>.jpg" width="350" height="350">
			        					<figcaption>
